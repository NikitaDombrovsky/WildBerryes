...
// Пробуем категорию "Женщинам", если нет — берём все товары
$products = $db->products()->getByCategory('Женщинам');
if (empty($products)) $products = $db->products()->getAll();
?>
<!DOCTYPE html>
<html lang="ru">
<head>
  ...
  <title>Женщинам — AvroraShop@</title>
...
<body>
  <div class="page">
    <main class="shell">
      <header class="top-bar">
        ...
        <div class="top-bar-actions">
          <nav class="nav">
            ...
            <a href="women.php"  class="nav-link is-active">Женщинам</a>
      ...
      <section class="left">
        <p class="kicker">Коллекция</p>
        <h1 class="hero-title">Для неё</h1>
        <p class="hero-lead">
          Платья, костюмы и база: спокойные формы, удобная посадка — от будней до выхода.
        </p>
        <div class="hero-meta">
          <span>Новые модели еженедельно</span>
        </div>
      ...
      <section class="right">
        <div class="right-head">
          ...
          <p>Подборка сезона — платья, костюм, верх и базовый слой.</p>
        </div>
