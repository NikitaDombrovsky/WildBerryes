...
$products = $db->products()->getByCategory('Мужчинам');
...
<head>
  ...
  <title>Мужчинам — AvroraShop@</title>
  ...
  <div class="page">
    <main class="shell">
      <header class="top-bar">
        ...
        <div class="top-bar-actions">
          <nav class="nav">
            ...
            <a href="man.php"    class="nav-link is-active">Мужчинам</a>
          </nav>
      ...
      <section class="left">
        ...
        <h1 class="hero-title">Для него</h1>
        <p class="hero-lead">
          Рубашки, куртки и брюки: классический крой и повседневный кэжуал в одной линейке.
        </p>
        <div class="hero-meta">
          <span>Размеры S–XXL</span>
        </div>
        <div class="hero-actions">
          <a href="index.php"  class="btn btn-primary">Главная</a>
          <a href="women.php"  class="btn btn-ghost">Женщинам</a>
        </div>
      </section>
      ...
      <section class="right">
        <div class="right-head">
          ...
          <p>Подборка сезона — рубашки, трикотаж, верх и брюки.</p>
        </div>
